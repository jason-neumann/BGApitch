...
$machinestates = array(
    ...
    20 => array(
        "name" => "newHand",
        "description" => "Starting a new hand.",
        "type" => "game",
        "action" => "stNewHand",
    ...
    25 => array(
        ...
        "transitions" => array( "discardDown" => 28 )
    ),
    ...
    28 => array(
        ...
        "description" => "",
        "type" => "game",
        "action" => "stFirstToDiscard",
        "transitions" => array( "discardDown" => 26 )
    ),

    26 => array(
        "name" => "discardDown",
        "description" => clienttranslate('${actplayer} is discarding down.'),
        "descriptionmyturn" => clienttranslate('Select your cards to discard.'),
        "type" => "activeplayer",
        "possibleactions" => array( "discardCards" ),
        "transitions" => array( "nextDiscard" => 27, "newTrick" => 30 )
    ),
    
    27 => array(
        "name" => "nextDiscard",
        "description" => 'Picking the next player.',
        "type" => "game",
        "action" => "stNextDiscard",
        "transitions" => array( "discardDown" => 26, "newTrick" => 30 )
    ), 

    // Trick    
    30 => array(
        "name" => "newTrick",
        "description" => "Starting a new trick.",
        "type" => "game",
        "action" => "stNewTrick",
